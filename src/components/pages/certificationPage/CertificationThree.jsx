...
import certificateImage from "../../../assets/cThreewebP.webp"; // Replace with actual path
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center">
          <img
            ...
            alt="ISO 9001:2015 Quality Certification from International Bench Marking & Certification for Kurali"
...
CertificationThree.displayName = 'CertificationThree';

export default CertificationThree;
